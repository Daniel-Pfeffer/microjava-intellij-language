...
class MicroJavaClassTypeReference(
    element: MicroJavaSimpleType,
) : PsiReferenceBase<MicroJavaSimpleType>(element), PsiPolyVariantReference {
    ...
    companion object {
        val LOG = Logger.getInstance(MicroJavaClassTypeReference::class.java)
    }
    ...
    override fun multiResolve(incompleteCode: Boolean): Array<ResolveResult> {
        ...
        val reference = MicroJavaUtil.findReferenceToClassDecl(
            myElement,
            name
        ) ?: return emptyArray()
